...
RSpec.describe "girlfriends/new", :type => :view do
  before(:each) do
    assign(:girlfriend, Girlfriend.new(
      :name => "MyString",
      :fav_food => "MyString",
  ...
  it "renders new girlfriend form" do
    render

    assert_select "form[action=?][method=?]", girlfriends_path, "post" do
